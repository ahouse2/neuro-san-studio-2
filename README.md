...
Ensure you have a supported version of python (3.11 at this time):
...
After debugging you can bundle the studio into a standalone `.exe` using
PyInstaller. Install the build requirements and run the packaging script:

```powershell
pip install -r requirements-build.txt
python package_windows_exe.py
```
